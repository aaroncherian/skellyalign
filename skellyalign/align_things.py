...
def get_best_transformation_matrix_ransac(freemocap_data, qualisys_data, frames_to_sample=10, initial_guess=[0,0,0,0,0,0,1], max_iterations=10, inlier_threshold=70):
